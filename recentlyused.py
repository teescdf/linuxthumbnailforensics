...
# The script should be run against a recently-used.xbel file, using the command line structure of 'python linuxthumbparse.py /path/to/recently-used.xbel'. The data is then output into a CSV file called 'recent.csv'
# The hash of the file URI can be cross referenced against the files found in a user's /cache/thumbnails directory to find matches 
